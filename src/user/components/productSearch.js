...
function ProductSearch({ handleShowModal, query, pagination }) {
    ...
    const fetchData = () => {
        ...
        const apiEndpoint = `${API_URL}products/find?query=${query}&page=${currentPage}&size=${itemsPerPage}&sort=id`;
            ...
            <section className="bg0 p-t-23 p-b-100">
                <div className="container">
                    ...
                    <div className="bread-crumb flex-w p-l-25 p-r-15 p-b-15 p-lr-0-lg">
                        ...
                        <span className="stext-107 cl4">Tìm kiếm</span>
                    </div>
                    <div
                        className="m-b-30"
                        style={{
                    ...
                    >
                        <div
                            className="mtext-112"
                            style={{ marginLeft: '25px', alignSelf: 'baseline', height: '100%', marginTop: '16px' }}
                        >
                            TÌM KIẾM
                        </div>
                        <span
